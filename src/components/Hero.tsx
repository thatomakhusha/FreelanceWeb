    ...
    return (
        <section className="section flex min-h-screen flex-col justify-center">
            <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between md:gap-0">
                <div className="flex items-center gap-3 font-mono text-sm text-accent uppercase">
                    <span className="h-2 w-2 rounded-full bg-accent"></span>
                    Available for work
                </div>

                <p className="font-mono text-xs uppercase tracking-[0.06em] text-muted-forground md:text-sm">
            ...
            <p className="mb-10 mt-8 max-w-2xl font-mono text-base leading-relaxed text-muted-forground md:text-lg">
                I design and build fast, modern websites for businesses,
            ...
            <div className="flex flex-wrap items-center gap-6">
                ...
                <a
                    href="#contact"
                    className="border-b border-muted pb-1 font-mono text-sm uppercase tracking-[0.06em] text-foreground transition-colors duration-200 hover:border-accent"
                >
