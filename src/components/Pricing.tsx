  ...
  return (
    <section id="pricing" className="section">
      <SectionLabel number="04" label="Pricing" />
        ...
        <p
            className="border-l-2 border-accent pl-4 pt-2 text-[0.75rem] leading-[1.7] tracking-[0.06em] text-muted-forground"
        >
            All prices are starting points. Final pricing depends on project scope,
            complexity, and timeline. Every project begins with a free consultation.
        </p>

        <div className="mt-10 bg-hover border-2 border-border">
            <div className="flex items-center justify-between gap-10 p-5">
                
                <div className="shrink-0 bg-background border border-border px-3 py-1 font-mono text-xs uppercase tracking-wider text-muted-forground">
                    Optional add-on
                </div>

                <div className="flex-1">
                <h3 className="mb-2 text-xl font-family">
                    Ongoing Maintenance
                </h3>
                <p className="max-w-xl text-sm leading-relaxed text-muted">
                    Keep your website updated, secure, and running smoothly after launch.
                </p>
                </div>

                <div className="flex shrink-0 items-center gap-6">
                    <div>
                        <h3 className="text-2xl font-family font-bold ">
                            R500
                        </h3>
